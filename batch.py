...
def work(command):
    """
    Wrapper function to call a subprocess. For use with multiprocessing.Pool in order to spawn subprocesses in a pool.
    
    :type command: list
    :param command: list of elements in the command to call.
    """
...
if __name__ == '__main__':
    ...
    parser.add_argument('-l', '--length', metavar='s', default=10, type=float, help='length of output in seconds')
    ...
    parser.add_argument('-o', '--output', metavar='file', default='./', type=str, help='base path for output')
