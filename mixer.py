...
def output_grain_annotations(grains, rate, wavname, filename):
    ...
    :type rate: int
    :param rate: sampling rate of graints
    :type wavname: str
...
def simple_grain_train(coords, sounds, length=10, graindur=(500, 2000), jumpdev=60):
    ...
    :type length: number
    :param length: duration of granular synthesis in seconds.
    :type graindur: (number, number)
    :param graindur: range of duration of grains in milliseconds, (low, high)
    :type jumpdev: number
